...
<form action="{{url('/')}}" method="GET">
    <div class="card">
        <div class="card-body">
            <div class="card-header">Find Therapists</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        <button class="btn btn-primary" type="submit">Find Therapists</button>
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-header"> Therapists </div>
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <tbody>
                       @forelse($doctors as $doctor)
                        ...
                        @empty
                        <td>No therapists available today</td>
                        @endforelse
