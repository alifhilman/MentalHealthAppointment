...
<div class="row justify-content-center">
	...
	<div class="card-body">
		<form class="forms-sample" action="{{route('user_list.store')}}" method="post" enctype="multipart/form-data" >@csrf
			<div class="row">
				<div class="col-lg-6">
			...
			<div class="row">
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<input type="text" name="education" class="form-control @error('education') is-invalid @enderror" placeholder="User highest education" value="{{old('education')}}">
                         @error('education')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
					...
					<div class="col-lg-6">
						...
						<input type="text" name="address" class="form-control @error('address') is-invalid @enderror" placeholder="User address"  value="{{old('address')}}">
                         @error('address')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
